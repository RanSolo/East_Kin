...
destruction_messages = new Array(
  ...
  "It's the same old ring.. on a different bell.",
  "Have you heard the news about things back home?",
  "...it's either fight or flight, won't know which is right...",
  "There's one or two things... make a lumberjack scared.",
  "No time to talk now... the fuse is lit.",
  ...
  "Have you destroyed or restarted East Kin's Universe?",
...
welcome_messages = new Array(
    ...
    "Flowers or...",
    "Darkness or...",
    "This time it's this or that...",
    "This time it's tit for tat...",
    "The sun is hanging lower...",
    "Dreams live past the horizon, then fade into the heat...",
    "Might be levelling. Might be deshevelling...",
    "The awakening might be a rude thing.",
