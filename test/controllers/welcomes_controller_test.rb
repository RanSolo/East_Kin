...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { bandName: @welcome.bandName, headline: @welcome.headline, logo: @welcome.logo, message: @welcome.message }
    end
  ...
  test "should update welcome" do
    patch :update, id: @welcome, welcome: { bandName: @welcome.bandName, headline: @welcome.headline, logo: @welcome.logo, message: @welcome.message }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
